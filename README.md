...
Продукт представляет собой html-страницы для загрузки файла, загруженного с [Росстата](https://rosstat.gov.ru/statistics/price). <br>
Скрипт настроен для обработки файла ipc_mes...xlsx. Примеры лежат в папке uploads. <br>
